    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-gradient-to-br from-purple-50/30 via-blue-50/30 to-purple-50/30">
        <Sidebar>
          ...
          <SidebarContent>
            <SidebarGroupI'll help you add a "New Chat" button that creates a new chat session. This will be added to the chat interface.

<lov-code>
Let's update the Chat page to include a new chat button:

<lov-write file_path="src/pages/Chat.tsx">
import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { Button } from "@/components/ui/button";
import { LogOut, Plus } from "lucide-react";
