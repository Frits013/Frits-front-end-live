...
import { validateEmail, sanitizeInput, RateLimiter } from "@/lib/input-validation";
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your registered email" className="pl-10 border-2 focus:ring-2 transition-all duration-200 border-blue-200 focus:border-blue-400 focus:ring-blue-100" required />
