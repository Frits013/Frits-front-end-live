...
export const AuthContent = () => {
  ...
  const { handleSignInWithGithub, handleSignInWithGoogle } = useAuthOperations();
  ...
  return (
    <div className="flex flex-col space-y-6">
      ...
      {/* Social login buttons with theme-appropriate styling */}
      <div className="flex flex-col space-y-3">
        ...
        >
          ...
          {authView === 'sign_in' ? 'Sign in with Google' : 'Sign up with Google'}
        </Button>
